...
from electrum_vior.util import get_resource_path as rsrc
from electrum_vior.bitcoin import is_valid
...
import re
import time
from electrum_vior.wallet import Wallet, WalletStorage
import webbrowser
...
from electrum_vior.version import ELECTRUM_VERSION as electrum_version
from electrum_vior.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a ViorCoin address or contact"))
        ...
        self.setWindowTitle("Electrum-VIOR")
    ...
    def the_website(self):
        webbrowser.open("http://electrum-vior.org")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your ViorCoin address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive ViorCoin payment"))
...
class MiniActuator:
    ...
    def waiting_dialog(self, f):
        ...
        w = QDialog()
        w.resize(200, 70)
        w.setWindowTitle('Electrum-VIOR')
