...
from electrum_vior import Wallet, Wallet_2of2, Wallet_2of3
import electrum_vior.bitcoin as bitcoin
...
MSG_ENTER_ANYTHING    = _("Please enter a wallet seed, a master public key, a list of ViorCoin addresses, or a list of private keys")
...
class InstallWizard(QDialog):
    ...
    def __init__(self, config, network, storage):
        ...
        self.setWindowTitle('Electrum ViorCoin')
    ...
    def create_cold_seed(self, wallet):
        from electrum_vior.bitcoin import mnemonic_to_seed, bip32_root
