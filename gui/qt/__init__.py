...
from electrum_vior.util import print_error, print_msg, parse_url
...
from electrum_vior import WalletStorage, Wallet
...
from electrum_vior.plugins import init_plugins
...
class ElectrumGui:
    ...
    def build_tray_menu(self):
        ...
        m.addSeparator()
        m.addAction(_("Exit Electrum-VIOR"), self.close)
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Electrum-VIOR')
