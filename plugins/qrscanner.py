from electrum_vior.util import print_error
...
from electrum_vior_gui.qt.qrcodewidget import QRCodeWidget
from electrum_vior import bmp
from electrum_vior_gui.qt import HelpButton, EnterButton
import json
...
from electrum_vior import BasePlugin
class Plugin(BasePlugin):
    ...
    def show_raw_qr(self):
        ...
        if not is_valid(to_address):
            QMessageBox.warning(self.gui.main_window, _('Error'), _('Invalid ViorCoin Address') + ':\n' + to_address, _('OK'))
            return
...
if __name__ == '__main__':
    ...
    assert(parse_uri('viorcoin://LcUP7ZU3Xpk1BUR3qut3dTjC3aK5JoZMYx') ==
           {'address': 'LcUP7ZU3Xpk1BUR3qut3dTjC3aK5JoZMYx'})
    
    assert(parse_uri('viorcoin:LcUP7ZU3Xpk1BUR3qut3dTjC3aK5JoZMYx') ==
           {'address': 'LcUP7ZU3Xpk1BUR3qut3dTjC3aK5JoZMYx'})
    
    assert(parse_uri('viorcoin:LcUP7ZU3Xpk1BUR3qut3dTjC3aK5JoZMYx?amount=10') ==
           {'amount': '10', 'address': 'LcUP7ZU3Xpk1BUR3qut3dTjC3aK5JoZMYx'})
    
    assert(parse_uri('viorcoin:LcUP7ZU3Xpk1BUR3qut3dTjC3aK5JoZMYx?amount=10&label=devfund&message=Donation%20to%20the%20dev%20fund') ==
