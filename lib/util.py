...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-vior")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-VIOR")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-VIOR")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-vior/"
    else:
...
def appdata_dir():
    ...
    if platform.system() == "Windows":
        ...
        return os.path.join(sys.prefix, "share", "electrum-vior")
    elif (platform.system() == "Darwin" or
          platform.system() == "DragonFly" or
          platform.system() == "OpenBSD" or
          platform.system() == "FreeBSD" or
	  platform.system() == "NetBSD"):
        return "/Library/Application Support/Electrum-VIOR"
    else:
