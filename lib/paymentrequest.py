...
REQUEST_HEADERS = {'Accept': 'application/viorcoin-paymentrequest', 'User-Agent': 'Electrum'}
ACK_HEADERS = {'Content-Type':'application/viorcoin-payment','Accept':'application/viorcoin-paymentack','User-Agent':'Electrum'}

ca_path = os.path.expanduser("~/.electrum-vior/ca/ca-bundle.crt")
ca_list = {}
try:
    ...
    print "ca-bundle.crt file should be placed in ~/.electrum-vior/ca/ca-bundle.crt"
